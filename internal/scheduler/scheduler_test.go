...
func (m *mockMessageService) reset() {
	m.mu.Lock()
	defer m.mu.Unlock()
	m.processPendingCalled = 0
	m.retryFailedCalled = 0
	m.processPendingError = nil
	m.retryFailedError = nil
	m.processPendingDelay = 0
	m.retryFailedDelay = 0
}
